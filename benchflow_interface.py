#!/usr/bin/env python3
# BenchFlow Interface for USACO
# This file is a template for integrating USACO with BenchFlow
...
class BenchflowInterface:
    ...
    def load_benchmark(self) -> bool:
        ...
        try:
            ...
            print(f"Loading USACO benchmark...")
            return True
    ...
    def get_benchmark_info(self) -> Dict[str, Any]:
        ...
        return {
            ...
            "version": "1.0.0",
            "category": "code",
            "github": "https://github.com/usaco/usaco-problems",
            "paper": "",
            "website": ""
        }
